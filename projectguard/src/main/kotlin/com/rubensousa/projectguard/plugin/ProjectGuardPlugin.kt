 ...
 * - Save the restrictions to individual module reports by checking them against the spec defined by [ProjectGuardExtension]
...
class ProjectGuardPlugin : Plugin<Project> {
    ...
    private val pluginId = "projectguard"
     ...
     */
    private fun getExtension(rootProject: Project): ProjectGuardExtension {
        return rootProject.extensions.findByType(ProjectGuardExtension::class.java)
            ?: rootProject.extensions.create(
                "projectGuard",
                ProjectGuardExtension::class.java
            )
    }
    ...
    private fun createAggregateDependencyDumpTask(
        ...
        return rootProject.tasks.register(
            "projectGuardAggregateDependencyDump",
    ...
    private fun createAggregateRestrictionTask(
        ...
        return rootProject.tasks.register(
            "projectGuardAggregateRestrictionDump",
    ...
    private fun createBaselineReferenceTask(
        ...
        return rootProject.tasks.register(
            "projectGuardCreateBaselineFile",
